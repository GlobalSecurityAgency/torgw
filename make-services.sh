...
do
	...
	echo '(echo "WarnUnsafeSocks 0";echo "WarnPlaintextPorts 1";echo "Log warn-err stderr";echo "DataDirectory /tmp/.tordata/tor"'$userno';echo "ControlPort 2000'$userno'";echo "SOCKSPort 905'$userno'";echo "HashedControlPassword $pswhash")|'"exec tor -f /dev/stdin --SocksPort 905$N --PidFile /var/run/tor.$N.pid --CookieAuthentication 1 --Sandbox 0 --DataDirectory /tmp/.var_lib_tor/$N" 
	) > $SVFILE
